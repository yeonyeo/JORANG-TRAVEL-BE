...
@Configuration
@Component
public class FindLoginIdEmailSender {
    @Value("${mail.sender}")
    ...
    public void emailSender(String nickname, String email, String loginId) throws MessagingException {
        ...
        String emailContent = nickname + "님의 아이디는 " + loginId +" 입니다.";
